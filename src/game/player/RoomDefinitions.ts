...
export const interactionAt=(x:number,westernHall:boolean)=>near(x,INTERACTIONS.elara)?"elara":near(x,INTERACTIONS.nightBell)?"bell":near(x,INTERACTIONS.westernHall)?westernHall?"western":"sealed":"map";
